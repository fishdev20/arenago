                  ...
                  >
                        ...
                        return (
                          <Badge
                            ...
                            className={cn(
                              ...
                              customStyle?.gradient && 'text-base border-transparent',
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        ...
                        <XCircle
                          className={cn(
                            'ml-2 h-4 w-4 cursor-pointer flex items-center justify-center',
                        ...
                        return (
                          ...
                          >
                            <div
                              className={cn(
                                'mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary',
                                isSelected ? 'bg-primary text-base' : 'opacity-50 [&_svg]:invisible'
                              )}
                              aria-hidden="true"
                            >
                              <CheckIcon className="h-4 w-4 text-white" />
